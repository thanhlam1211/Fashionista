 ...
 */
package Project.Controller.ProductController;
...
public class InsertProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dao.getProduct(ProID) != null) {
            //them thong bao da ton tai product
        ...
        Product p = new Product(ProID, ProName, ProBranch, ProImage, ProCategorieID, ProSubCategorieID, ProSuppliers, ProPrice, Stock);
